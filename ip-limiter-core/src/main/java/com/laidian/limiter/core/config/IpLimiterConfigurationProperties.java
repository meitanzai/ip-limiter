...
import com.laidian.env.checker.RuntimeEnvironment;
import com.laidian.env.checker.util.SystemUtil;
...
public class IpLimiterConfigurationProperties {
	private static Map<RuntimeEnvironment, String> dashboardAddressMap = new HashMap<RuntimeEnvironment, String>();
	static {
		dashboardAddressMap.put(RuntimeEnvironment.DEV, "ip-limiter.dev.imlaidian.com");
		dashboardAddressMap.put(RuntimeEnvironment.TEST, "ip-limiter.test.imlaidian.com");
		dashboardAddressMap.put(RuntimeEnvironment.PRE, "ip-limiter.pre.imlaidian.com");
		dashboardAddressMap.put(RuntimeEnvironment.PRD, "ip-limiter.imlaidian.com");
	}
	// 每秒每个IP最大允许的ＱＰＳ
	...
	// IP Limiter控制台的地址
	private String dashboardAddress = null;
