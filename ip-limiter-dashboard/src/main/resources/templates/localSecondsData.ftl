...
<body>
	...
	<table width="100%" border="1">
		<tr>
			<td colspan="6" align="center" style="font-weight:bold">当前应用最近10秒的IP访问TOP统计</td>
		</tr>
		<tr>
...
<script language="JavaScript">
	function changeIp(ip){
		...
		window.location.href="/limiter/getIpSecondAccessPretty?appName="+appName+"&ip="+ip+"&ts="+ts+"&lastSeconds="+lastSeconds+"&refreshInterval="+refreshInterval;
	}
